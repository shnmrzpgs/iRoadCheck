        ...
        <div class="text-[#202020] bg-[#FBFBFB] pt-4 lg:px-2 px-0 pb-4 rounded-lg w-full min-w-[40vh] max-w-full h-full min-h-[60vh] max-h-full "
             x-data="{
                ...
                userTypes: [
                    ...
                    { userType: 'Developer', permissions: ['Access Restricted Data', 'Update Profile'], status: 'Pending' },
                    { userType: 'Analyst', permissions: ['Generate Reports', 'View Logs', 'Export Data'], status: 'Enabled' },
                    { userType: 'Support', permissions: ['Reset Passwords', 'Monitor Activity'], status: 'Disabled' },
                    { userType: 'Inventory', permissions: ['Manage Inventory', 'Archive Data'], status: 'Enabled' }
                ],
                permissions: [
                ...
                togglePermission(permissionId) {
                    if (this.formData.permissions.includes(permissionId)) {
                        this.formData.permissions = this.formData.permissions.filter(id => id !== permissionId);
                    } else {
                            ...
                            <div class="w-full">
                                <div @click="showAddModal = true">
                                    ...
                                    <button type="submit" name="addUser" id="addUser" value="addUser"
                                        ...
                                        <span class="ml-0 mt-[2px] text-[#FFFFFF] text-md">Add User Type</span>
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-1 bg-[#3AA76F] border-gray-600 rounded-[12px] shadow-xl overflow-hidden w-full max-w-lg mx-10 my-4">
                            <div class="bg-[#FBFBFB] rounded-[10px] relative">
                                ...
                                <div class="bg-gray-100 rounded-t-[8px] w-full text-[14px] px-4 py-3">
                                    <div class="text-[#3AA76F] font-medium text-lg">Adding User Type</div>
                                </div>
                    ...
                    <div class="inline-block min-w-full max-h-[56vh] min-h-[48vh] overflow-y-auto align-middle">
                        <table class="min-w-full text-left divide-y divide-gray-300">
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                <template x-for="(userType, index) in userTypes" :key="index">
                                <!-- Alternating background colors for striped rows -->
                                <tr :class="index % 2 == 0 ? 'bg-white' : 'bg-slate-50' " class="hover:bg-slate-200 text-left">
                                    <td class="whitespace-nowrap py-3 text-[12px] pl-4">
                                        <div class="ml-2">
                                            <div class="mt-[1px] text-[12px]" x-text="index + 1">
                                                <!-- Row number -->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="whitespace-nowrap pl-4 py-3 text-[12px]">
                                        <div class="font-normal" x-text="userType.userType">
                                            <!-- Dynamic content for item name -->
                                        </div>
                                    </td>

                                    <td class="whitespace-nowrap pl-4 py-3 text-[12px]">
                                        <div class="font-normal truncate max-w-[150px]" x-text="userType.permissions.join(', ')">
                                            <!-- Dynamic content for permissions -->
                                        </div>
                                    </td>

                                    <td class="whitespace-nowrap pr-7 py-3 text-xs font-medium">
                                        <div
                                            :class="userType.status === 'Enabled' ? 'text-green-600 font-bold' : 'text-red-600 font-bold'"
                                            x-text="userType.status">
                                        </div>
                                    </td>
                                    ...
                                    <td class="flex whitespace-nowrap py-6 text-left">
                                        ...
                                        <button class="flex text-[#3251FF] hover:underline mr-5 pl-8">
                                            ...
                                            <span class="text-[12px] font-medium">View</span>
                                        </button>
                                    </td>
                                </tr>
                            </template>
