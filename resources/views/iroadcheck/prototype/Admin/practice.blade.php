...
{{--         class="shadow-[0px_5px_40px_rgba(0,0,0,0.5)] fixed bottom-0 left-0 right-0 bg-white shadow-lg flex justify-between items-center px-2 py-3 rounded-t-2xl w-full">--}}
{{--        <!-- Dashboard -->--}}
{{--        <div--}}
...
{{--                <svg--}}
{{--                    class="absolute -mt-8 w-[106px] h-[80px]"--}}
{{--                    viewBox="0 0 67 25"--}}
{{--                    fill="none"--}}
...
{{--                <!-- Icon -->--}}
{{--                <div--}}
{{--                    class="z-50 relative flex justify-center items-center mt-2 pb-1"--}}
{{--                    :class="activeTab === 'dashboard' ? '-top-3 text-white' : 'text-[#4AA76F]'">--}}
...
{{--            <!-- Wave Shape -->--}}
{{--            <div--}}
{{--                class="absolute top-0 left-5 w-full h-full z-0"--}}
...
{{--                    :class="activeTab === 'report-road-issue' ? '-top-3 text-white' : 'text-[#4AA76F]'">--}}
...
{{--        <!-- Suggestion Report -->--}}
{{--        <div--}}
{{--            @click="activeTab = 'suggestion-report'"--}}
{{--            class="relative flex flex-col items-center transition-all duration-300 [transition-timing-function:cubic-bezier(0.175,0.885,0.32,1.275)] active:-translate-y-1 active:scale-x-90 active:scale-y-110">--}}
{{--            <!-- Wave Shape -->--}}
{{--            <div--}}
{{--                class="absolute top-0 left-6 w-full h-full z-0"--}}
{{--                :class="activeTab === 'suggestion-report' ? 'block' : 'hidden'">--}}
{{--                <svg--}}
{{--                    class="absolute -mt-8 w-[106px] h-[80px]"--}}
{{--                    viewBox="0 0 67 25"--}}
{{--                    fill="none"--}}
...
{{--                <div--}}
{{--                    class="z-50 relative flex justify-center items-center mt-2"--}}
{{--                    :class="activeTab === 'suggestion-report' ? '-top-3 text-white' : 'text-[#4AA76F]'">--}}
{{--                    <svg  class="h-7 w-7" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">--}}
...
{{--                <!-- Label -->--}}
{{--                <span--}}
{{--                    :class="activeTab === 'suggestion-report' ? 'text-[#4AA76F] font-semibold' : 'text-[#4AA76F]'"--}}
{{--                    class="mt-1 text-xs">--}}
{{--                    Suggestion Reports--}}
{{--                  </span>--}}
{{--            </div>--}}
...
{{--            <!-- Wave Shape -->--}}
{{--            <div--}}
{{--                class="absolute top-0 left-2 w-full h-full z-0"--}}
...
{{--                <div--}}
{{--                    class="z-50 relative flex justify-center items-center mt-2"--}}
{{--                    :class="activeTab === 'report-history' ? '-top-3 text-white ' : 'text-[#4AA76F]'">--}}
{{--                    <svg class="h-7 w-7" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">--}}
...
{{--        </div>--}}
    ...
    <div class="flex justify-center items-center w-full h-full">
        <div class="w-full h-full flex justify-center items-center">
            <div class="p-4 bg-white shadow-lg rounded-lg w-full max-w-screen-xl">
                <h1 class="text-3xl font-bold text-center">Welcome to the Full-Screen Layout</h1>
                <p class="text-center">This content is centered and occupies the full screen.</p>
            </div>
        </div>
    </div>
</x-app-layout>
