    ...
    <div class="bg-[#000000]">
        ...
        <div class="flex justify-center items-center h-screen">
            <div class="w-[400px] py-5 bg-[#FFFFF9] bg-blend-multiply drop-shadow-lg rounded-[15px] z-10 px-10 mx-6">
                <form action="" method="POST" class="flex flex-col items-center w-full" x-data="{ showPassword: false }">
                    ...
                    <div class="relative">
                        <input :type="showPassword ? 'text' : 'password'" class="rounded border border-gray-400 focus:border-amber-500 focus:ring-1 focus:ring-amber-500 focus:outline-none text-[14px] text-gray-600 w-full py-2 pl-10 pr-10 bg-[#FFFFF9]"
