<x-app-layout>
    <div class="min-h-screen flex flex-col items-center bg-white">
        ...
        <div class="w-full bg-white py-6 lg:w-full">
            <!-- Navigation Tabs -->
            <div class="flex overflow-x-auto whitespace-nowrap lg:w-full" style="scrollbar-width: none; -ms-overflow-style: none; overflow-x: auto;">
        ...
        <div class="w-[90%] bg-gray-100 rounded-lg p-6 mt-6 lg:-ml-22" style="box-shadow: inset 0 4px 6px rgba(0, 0, 0, 0.25);">
        ...
        <div class="mt-6 bg-white w-[80%] lg:w-[90%] shadow-lg rounded-lg h-[400px] p-1 border border-gray-100">
        ...
        <div class="mt-9 w-[75%] text-center max-w-lg lg:absolute lg:top-14 lg:right-0 lg:m-6 lg:w-[auto] lg:max-w-[200px]">
            <button x-data @click="window.location.href='{{ route('report-road-issue-step1') }}'" class="px-6 py-4 w-full bg-white text-xl font-semibold text-[#F8A15E] shadow-md rounded-full border-2 border-[#F8A15E] lg:px-4 lg:py-2 lg:text-sm">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 inline-block mr-2 lg:h-6 lg:w-6" fill="currentColor" viewBox="0 0 30 30">
