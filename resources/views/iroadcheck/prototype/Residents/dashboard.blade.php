<x-app-layout>
    <div class="min-h-screen flex flex-col items-center bg-white">
        ...
        <div class="overflow-y-auto flex flex-col items-center w-full">
            <!-- Flex container to align image and text horizontally -->
            <div class="w-[90%] bg-gray-100 rounded-lg p-6 mt-20 lg:-ml-22" style="box-shadow: inset 0 4px 6px rgba(0, 0, 0, 0.25);">
