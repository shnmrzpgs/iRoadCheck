<x-app-layout>
    <div class="min-h-screen flex flex-col items-center bg-white">
        ...
        <div class="mt-9 w-[75%] text-center max-w-lg lg:absolute lg:top-16 lg:right-0 lg:left-[85%] lg:m-6 lg:w-[auto] lg:max-w-[200px]">
            <button x-data @click="window.location.href='{{ route('report-road-issue-step2') }}'" class="px-6 py-4 lg:py-1 lg:text-[14px] w-full bg-customGreen text-xl font-semibold text-white shadow-md rounded-full border-2 hover:bg-green-400">       
               NEXT
            </button>
        </div>
