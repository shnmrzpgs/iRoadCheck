                ...
                <template x-if="step === 2">
                    <div class="w-[90%]">
                        ...
                        <div class="mt-9 w-[75%] text-center mx-auto">
                            <button class="px-4 text-[12px] py-3 w-full bg-customGreen text-lg font-semibold text-white shadow-md rounded-full border-2 hover:bg-green-600 flex items-center justify-center space-x-2">
                    ...
                    <div>
                        ...
                        <div class="mt-6 mx-auto bg-white w-[80%] max-w-md shadow-sm rounded-lg border-2 border-gray-300 p-4 h-auto lg:h-[600px]">
                            ...
                            <div class="mb-6 w-full flex justify-items-start">
                                ...
                                <div class="w-5/10 ml-1 text-sm">Apokon Street, Tagum City</div>
                            </div>
                        </div>

                        <!-- Report Road Issue Button -->
                        <div class="mt-6 w-[75%] text-center mx-auto mb-5">
                            <button x-data @click="window.location.href='{{ route('suggestion-reports') }}'" class="px-4 py-3 w-full bg-customGreen text-lg font-semibold text-white shadow-md rounded-full border-2 hover:bg-green-600">
                                SUBMIT REPORT
                            </button>
                        </div>
                    </div>
