        ...
        <div class="flex items-center justify-center text-center mt-20">
            <template x-if="step === 1">
                <div>
                    ...
                    <div x-data="{ selected: null }" class="mt-6 mx-auto bg-white w-full lg:w-full shadow-sm rounded-lg  border-2 border-gray-300 h-[520px] lg:h-[450px]">
                    ...
                    <div class="mt-6 w-[75%] text-center mx-auto max-w-lg lg:absolute lg:top-16 lg:right-0 lg:left-[85%] lg:m-6 lg:w-[auto] lg:max-w-[200px] md:mb-50 sm:mb-50">
                        <button @click="step = 2"
                            class="px-4 py-3 lg:py-1 lg:text-[14px] w-full bg-customGreen text-lg font-semibold text-white shadow-md rounded-full border-2 hover:bg-green-400 md:mb-50">
                            NEXT
                        </button>
                    </div>
                </div>
            ...
            <template x-if="step === 2">
                <div class="w-[90%]">
                    ...
                    <!-- Report Road Issue Button -->
                    <div class="mt-9 w-[75%] text-center mx-auto">
                        <button class="px-4 text-[12px] py-3 w-full bg-customGreen text-lg font-semibold text-white shadow-md rounded-full border-2 hover:bg-green-400 flex items-center justify-center space-x-2">
                    ...
                    <div class="mt-3 w-[75%] text-center mx-auto">
                        <button @click="step = 3"
                            class="px-4 py-3 w-full bg-customGreen text-xl font-semibold text-white shadow-md rounded-full border-2 hover:bg-green-400">
                            NEXT
                        </button>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-6 mx-auto bg-white w-[80%] max-w-md shadow-sm rounded-lg border-2 border-gray-300 p-4 h-auto lg:h-[600px]">
                        ...
                        <div class=" text-center">
                            <span class="font-semibold text-customGreen text-md">Actual Captured Road Photo:</span>
                            <img src="{{ asset('storage/images/pothole1.png') }}" alt="Road Defect" class="relative w-full " />
                        </div>

                        <!-- Type of Defect -->
                        <div class="mb-6">
                            <span class="font-semibold text-customGreen text-sm">Type of Defect:</span>
                            <span class="text-sm">Pothole</span>
                        </div>

                        <!-- Report ID -->
                        <div class="mb-2">
                            <span class="font-semibold text-customGreen text-sm">Report ID:</span>
                            <span class="ml-2 text-sm">00001</span>
                        </div>

                        <!-- Date and Time -->
                        <div class="mb-2">
                            <span class="font-semibold text-customGreen text-sm">Date and Time:</span>
                            <span class="ml-2 mr-8 text-sm">10/12/2024</span>
                            <span class="ml-[46%] text-sm">08:34:02 AM</span>
                        </div>

                        <!-- Location -->
                        <div class="mb-6">
                            <span class="font-semibold text-customGreen text-sm">Location:</span>
                            <span class="ml-1 text-sm">Apokon Street, Tagum City</span>
                        </div>
                    </div>

                    <!-- Report Road Issue Button -->
                    <div class="mt-9 w-[75%] text-center mx-auto">
                        <button x-data @click="window.location.href='{{ route('suggestion-reports') }}'" class="px-4 py-3 w-full bg-[#FFAD20] text-lg font-semibold text-white shadow-md rounded-full border-2 hover:bg-yellow-400">
                            SUBMIT REPORT
                        </button>
                    </div>
                </div>
