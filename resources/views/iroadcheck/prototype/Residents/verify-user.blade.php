<x-app-layout>
    ...
    <div class="relative h-screen font-poppins  flex items-center justify-center overflow-auto">
        ...
        <div class="flex items-center justify-center h-screen">
            <div x-data="{ animation: null }" x-init="animation = lottie.loadAnimation({
                ...
                class="bg-white shadow-lg rounded-3xl px-12 py-8 w-full max-w-xs sm:max-w-sm text-center relative z-10 " style="box-shadow: 0 0 50px rgba(0, 0, 0, 0.4);">
                <h2 class="text-[22px] text-[#6AA76F] font-bold">Verify User</h2>
                <form action="" method="POST" class="flex flex-col items-center w-full">
                    ...
                    <!-- Button -->
                    <a href="{{ route('EnterCode') }}" class="w-full bg-gradient-to-r from-[#5A915E] to-[#F8A15E] text-white p-3 font-semibold mb-4 rounded-full text-center block mt-4">
                        Send Code
                    </a>
                </form>
            </div>
