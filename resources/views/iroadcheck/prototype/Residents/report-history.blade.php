    ...
    <div class="h-screen flex flex-col items-center bg-white">
        ...
        <div class="w-full lg:w-full bg-white py-6 ">
            ...
            <div class="flex overflow-x-auto whitespace-nowrap p-1" style="scrollbar-width: none; -ms-overflow-style: none; overflow-x: auto;">
                ...
                <button x-data @click="window.location.href='{{ route('report-road-issue-step1') }}'" class="px-4 py-1 bg-white  text-[13px] text-customGreen border border-customGreen rounded-full ml-2 shadow-md">Report Road Issue</button>
                <button class="px-4 py-1 bg-white  text-[13px] text-customGreen border border-customGreen rounded-full ml-2 shadow-md">Suggestion Report</button>
                <button class="px-4 py-1 bg-customGreen  text-[13px] text-white border border-customGreen rounded-full ml-2 shadow-md">Report History</button>
            </div>
