    ...
    <div class="min-h-screen flex flex-col items-center bg-white ">
        ...
        <div class="w-full bg-white py-6 lg:w-full">
            ...
            <div class="flex whitespace-nowrap lg:w-full">
                <button class="px-3 py-1 bg-customGreen text-white  text-[14px] border rounded-full ml-4 shadow-md">Personal Info</button>
                <button x-data @click="window.location.href='{{ route('profile-contact-info') }}'" class="px-3 py-1 bg-white text-customGreen border text-[14px] border-customGreen rounded-full ml-1 shadow-md">Contact Info</button>
        ...
        <div class="mt-6 bg-white w-[80%] shadow-lg rounded-lg h-[400px] p-1 border border-gray-100 lg:h-[200px]">
        ...
        <div class="mt-12 w-[75%] text-center lg:w-[20%]">
            <button x-data @click="window.location.href='{{ route('report-road-issue-step1') }}'" class="px-6 py-4 w-full bg-gradient-to-r from-[#5A915E] to-[#F8A15E] text-xl lg:text-[16px] lg:py-2 lg:mb-2 font-semibold text-white shadow-md rounded-full">
                Save Changes
            </button>
        </div>
