<x-residents.residents-navigation>
    <div class=" flex flex-col items-center w-auto" x-data="{ step: 1 }">
                    ...
                    <form id="step1Form">
                        <div x-data="{ selected: '' }" class="mt-4 mb-2 bg-white shadow-sm rounded-lg w-[350px] mx-auto border-2 border-gray-300 h-[455px]">
                            ...
                            <div class="h-[50vh] overflow-y-auto overflow-x-hidden w-full">
                                ...
                                <div @click="selected = 'slippageCracking'" :class="{ 'bg-gray-100': selected === 'slippageCracking' }" class="flex items-center border-b-2 border-gray-300 py-6 cursor-pointer">
                                    <img src="{{ asset('storage/images/slippage-cracking.png') }}" alt="Pothole" class="w-16 h-16 rounded mr-2 ml-4">
                                    <p class="text-[13px] text-gray-800 ml-2">Slippage Cracking</p>
                                </div>
                            </div>
                            <input type="hidden" name="defect_type" :value="selected" class="bg-emerald-500">
                        </div>
            ...
            <template x-if="step === 2">
                <div>
                    <div>
                        ...
                        <div class="capture-wrapper p-6 bg-[#4AA76F] rounded-lg shadow-lg" x-data="captureHandler()">
                            <!-- Open Camera Button -->
