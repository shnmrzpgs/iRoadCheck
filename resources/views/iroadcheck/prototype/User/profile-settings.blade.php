<x-app-layout>
    ...
    <x-User.user-navigation page_title="Profile">
        ...
        <div class="w-full h-full relative rounded-[6px] font-pop">
            ...
            <div class="pl-10 mt-16 w-full"
                ...
                <div class="lg:grid lg:place-items-start">
                    ...
                    <div class="text-[13px] z-10 mt-6 h-full max-h-[390px] w-full max-w-[1330px] rounded-md bg-[#FBFBFB] px-7 pb-7 drop-shadow-lg">
