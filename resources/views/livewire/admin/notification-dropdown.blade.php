<div x-data=
     ...
     class="relative">
        ...
        <span x-cloak
              x-show="showRedDot()"
              class="absolute scale-90 -top-0.5 -right-0.5 grid min-h-[24px] min-w-[24px] max-h-[34px] max-w-[34px] translate-x-2/4 -translate-y-2/4 place-items-center rounded-full border-2 border-[#202020] bg-red-600 py-1 px-1 text-xs text-white pointer-events-none">
            {{ $notifications_count }}
        </span>
