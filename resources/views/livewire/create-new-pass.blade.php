...
<div>
    ...
    <div class="relative h-screen font-poppins flex items-center justify-center overflow-hidden"
        ...
        <div class="flex items-center justify-center h-screen">
            <div class="bg-white shadow-lg rounded-2xl px-10 py-8 w-full max-w-xs sm:max-w-sm text-center relative z-10 mx-5"
                 style="box-shadow: 0 0 200px rgba(0, 0, 0, 0.2);">
                ...
                <form wire:submit.prevent="newPass" method="POST" class="flex flex-col items-center w-full"
                    ...
                    <div class="relative mb-2">
                        <input :type="showPassword ? 'text' : 'password'" wire:model="password"
                               class="rounded-lg border border-gray-400 focus:border-amber-500 focus:ring-1 focus:ring-amber-500 focus:outline-none text-[14px] text-gray-600 w-full py-2 pl-10 pr-10 bg-none"
                    ...
                    <button
                        ...
                        class="w-full text-[14px]  bg-gradient-to-r from-[#5A915E] to-[#F8A15E] text-white p-3 font-semibold mb-4 rounded-full mt-4 transition-all duration-300 [transition-timing-function:cubic-bezier(0.175,0.885,0.32,1.275)] active:-translate-y-1 active:scale-x-90 active:scale-y-110">
                        Change Password
                    </button>
