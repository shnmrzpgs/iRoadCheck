    ...
    <div class="flex justify-center items-center sm:justify-start sm:items-start">
        <x-staff.crud-page-content-base>
            ...
            <x-slot:table_container wire:key="reports-table-{{ now() }}">
                <div class="inline-block w-[40vh] md:w-full lg:w-full h-[48vh] md:h-[52vh] lg:h-[55vh] xl:h-[62vh] xl:max-h-[100vh] overflow-y-auto align-middle drop-shadow rounded-b-md">
            ...
            <x-slot:modal_container>
                ...
                <!-- View Staff Modal -->
                <livewire:modals.staff.view-report-history-modal
