    ...
    <div class="flex justify-center items-center sm:justify-start sm:items-start">
        <x-admin.crud-page-content-base>
            ...
            <x-slot:dropdown_filters_container>
                ...
                ><span wire:click="resetFiltersAndSearch" class="cursor-pointer text-gray-300 block appearance-none w-full bg-[#262626] border border-none focus:ring-0 px-2 py-2 rounded shadow-none focus:outline-none focus:shadow- text-center"
                    >All Admin</span>
                </div>
                <div
                    x-data=
