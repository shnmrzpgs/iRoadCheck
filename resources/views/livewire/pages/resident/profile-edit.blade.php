<x-Residents.residents-navigation page_title="Profile Settings">
    ...
    <x-residents.profile-page-content-base>
        ...
        <x-slot:preview_names_and_user_type>
            <h2 class="text-[24px] font-semibold text-white drop-shadow capitalize">
        ...
        <x-slot:birthdate>
            ...
            <div x-data="{
                ...
                <input id="date_of_birth" type="text" x-ref="input" wire:model.defer="date_of_birth" placeholder="Select your birthdate"
                       readonly
                       class="appearance-none border border-gray-300 focus:ring-[0.5px] focus:ring-[#4AA76F] focus:border-[#4AA76F] w-full rounded-md bg-white text-[14px] text-gray-900 shadow @error('date_of_birth') @enderror">
            </div>
        </x-slot:birthdate>
        ...
        <x-slot:phone>
            <label for="phone" class="w-3/10 mb-2 mt-3 block text-[13px] font-medium text-gray-900">
                Phone Number
            </label>
