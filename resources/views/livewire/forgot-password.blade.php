...
<div>
    ...
    <div class="relative h-screen font-poppins  flex items-center justify-center overflow-hidden">
        ...
        <div x-data="{ animation: null }" x-init="animation = lottie.loadAnimation({
            ...
            <form wire:submit.prevent="checkPhone" method="POST" class="flex flex-col items-center w-full">
                ...
                <h2 class="text-[16px] font-bold mb-4 text-gray-800">Enter phone</h2>
                <div class="relative mx-5  mb-2">
                    <input
                        ...
                        class="w-full py-2 pl-10 pr-10 border rounded-lg focus:outline-none focus:ring-1 focus:ring-[#5A915E] text-center text-[20px] font-semibold focus:border-[#5A915E] tracking-wider font-mono"
                        placeholder=" "
                        autocomplete="off"
                    />
                    <img src="{{ asset('storage/icons/user.svg') }}" class="absolute left-1.5 top-3 h-4 w-4" alt="user">
                </div>
