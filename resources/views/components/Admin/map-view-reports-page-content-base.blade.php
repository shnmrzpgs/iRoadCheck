                        ...
                        <div class="bg-white h-full w-full rounded-[18px]">
                            <div class="p-0 block h-full w-full flex flex-col" x-data = "{showFilters: false}">
                                <div class="flex flex-wrap gap-4 mx-2">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <button
                                            ...
                                            class="ml-auto bg-white text-[#F59E0B] px-2 py-2 rounded-md flex items-center shadow-md hover:text-[#D97706] hover:shadow-lg transition-all border border-[#F59E0B]">
                                ...
                                <div x-show="showFilters"
                                     class="md:pl-2 flex justify-start items-start mb-1 mt-3 mx-1 mr-auto p-2 border-b border-b-gray-200">
                                ...
                                <div class="flex-1 overflow-y-auto min-h-[25vh] max-h-auto pb-16">
                                        ...
                                        <!-- Report Information -->
                                        <div class="flex justify-center items-center text-center font-semibold text-md mt-0 text-[#4D4F50] fixed bg-white w-full py-3 z-[99999]">Road Defect Report Information</div>

                                        <div class="pb-16 mt-16 px-6">
