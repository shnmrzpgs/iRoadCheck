...
<div class="bg-none mx-4 mt-3 font-pop text-white 0 p-0 " x-data="{ open: false, activeLink: localStorage.getItem('activeLink') || '', activeChildLink: localStorage.getItem('activeChildLink') || '' }">
    ...
    <div class="flex">
        ...
        <aside x-data="{
           ...
           class="bg-[#FBFBFB] hidden h-full py-4 lg:block rounded-xl mr-5 drop-shadow-md transition-all duration-300 ease-in-out">
        ...
        <div class="flex-1 flex flex-col" x-data="{ isClicked: false }">
            ...
            <header class="flex w-full my-6 mx-2">
                ...
                <h1 class="text-[22px] mt-1 font-semibold text-[#4AA76F]">{{$page_title}}</h1>
                <!--Search-->
                <div class="flex w-80 items-center px-5 mr-auto">
                    <form class="relative flex flex-1 h-8 rounded-full border-[#F8F7F7]" action="#" method="GET">
                        ...
                        <input id="search-field"
                               class="border border-gray-300 focus:outline-none focus:ring-[0.5px] focus:ring-[#4AA76F] focus:border-[#4AA76F] drop-shadow-md focus:bg-white bg-white rounded-full border-none block h-full w-full py-0 pl-8 text-gray-900 placeholder:text-gray-400 xs:text-[10px] sm:text-[10px] md:text-[12px] lg:text-[12px]"
