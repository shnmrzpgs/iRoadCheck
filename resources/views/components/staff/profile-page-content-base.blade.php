<div class="overflow-y-auto max-h-screen lg:overflow-visible">

    <div class="w-full h-[75vh] lg:h-[85vh] relative rounded-[6px] font-pop lg:w-[95%]">
        <div class="bg-none rounded-[4px] px-5 lg:px-0">
            ...
            <div class="flex flex-col lg:flex-row justify-center lg:justify-start items-center lg:items-start p-2 w-full">
                <div class="relative -mt-52 lg:-mt-24 flex flex-col items-center lg:items-start lg:ml-12">
                    ...
                    <div class="relative text-center lg:hidden mt-2 te">
        ...
        <!--Profile Information -->
        <div class="mt-5 w-full px-5 lg:px-0"
             x-data="{
            ...
            <div class="z-0 lg:grid lg:place-items-start">
                ...
                <div class="text-[13px] z-10 mt-6 h-full w-full max-w-[1330px]">

                    <!-- Basic Information -->
                    <div class="lg:max-h-[420px] w-full max-w-[1330px] rounded-md bg-[#FBFBFB] px-1 lg:px-8 pb-20 lg:pb-7 md:pb-7 drop-shadow-lg" x-show="activeTab === 'basic-info'">
                        <div class="pt-10 md:pl-5 text-[13px] italic text-gray-900 text-center md:text-start">
                    ...
                    <div class="lg:max-h-[420px] w-full max-w-[1330px] rounded-md bg-[#FBFBFB] px-1 lg:px-8 pb-20 lg:pb-7 md:pb-7 drop-shadow-lg" x-show="activeTab === 'access-control-info'">
                        <div class="pt-10 md:pl-5 text-[13px] italic text-gray-900 text-center md:text-start">
                    ...
                    <div class="lg:max-h-[420px] w-full max-w-[1330px] rounded-md bg-[#FBFBFB] px-1 lg:px-8 pb-20 lg:pb-7 md:pb-7 drop-shadow-lg" x-show="activeTab === 'account-info'">
                        <!-- Account Information -->
                        <div class="pt-10 md:pl-5 text-[13px] italic text-gray-900 text-center md:text-start">
