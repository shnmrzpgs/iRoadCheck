<div class="w-full h-[85vh] relative rounded-[6px] font-pop overflow-y-scroll ">
    ...
    <!--Profile Information -->
    <div class="pl-0 mt-6 w-full" x-data="{
        ...
        <div class="z-0 lg:grid lg:place-items-start">
            <div class="flex w-full items-center justify-start lg:text-[14px] text-[12px]">
                <!-- Basic Information Tab -->
                <div class="relative inline-block mr-6">
                    <button class="font-medium text-[#676767] hover:text-[#676767]" @click="activeTab = 'basic-info'"
                        @mouseenter="hoveredTab = 'basic-info'" @mouseleave="hoveredTab = null"
                ...
                <div class="relative inline-block mr-6">
                    <button class="font-medium text-[#676767] hover:text-[#676767]"
                        @click="activeTab = 'access-control-info'" @mouseenter="hoveredTab = 'access-control-info'"
                ...
                <div class="relative inline-block">
                    <button class="font-medium text-[#676767] hover:text-[#676767]" @click="activeTab = 'account-info'"
                        @mouseenter="hoveredTab = 'account-info'" @mouseleave="hoveredTab = null"
            ...
            <div
                class="text-[13px] z-10 mt-6 h-full max-h-[420px] w-full max-w-[1330px] rounded-md bg-transparent md:bg-[#FBFBFB] lg:bg-[#FBFBFB] px-1 lg:px-8 pb-20 lg:pb-7 md:pb-7 drop-shadow-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 my-6 space-x-0 md:space-x-6 px-4">
                            ...
                            <div class="w-full mt-6 md:mt-0">
                                ...
                                <div class="w-full pb-6 px-6">
                                    <div class="text-gray-600 text-[14px] font-semibold mb-4">Password Requirements
                                    </div>
                                    <div class="text-[13px] text-gray-500 mb-1">Please follow this guide for a strong
                                        password:</div>
