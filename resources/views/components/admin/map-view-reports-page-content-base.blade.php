        ...
        <div class="w-full inline-block align-middle p-0 z-0">
            <div class="flex" x-data="{ expanded: false }">
                ...
                <div class="w-full min-h-[35vh] max-h-[78vh] flex flex-col lg:flex-row">
                    ...
                    <div x-data="{ showFilters: false }" class="hidden lg:block  mt-2 p-0.5 rounded-[20px] h-[68vh] bg-white transition-all duration-300 overflow-hidden" :class="expanded ? 'w-0 hidden' : 'w-3/9 absolute flex justify-end items-end right-10 top-24 bg-gradient-to-b from-[#84D689] to-green-500 drop-shadow'">
