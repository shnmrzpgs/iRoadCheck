@props(['comprehensive_or_group_report_information'])
        ...
        <div class="w-full inline-block align-middle p-0 z-0">
            <div class="flex" x-data="{ expanded: false }">
                ...
                <div class="w-full min-h-[35vh] max-h-[70vh] lg:min-h-[35vh] lg:max-h-[78vh] flex flex-col lg:flex-row">
                    ...
                    <!-- Responsive Panel -->
                    <div>
                        <!-- Small screens: Draggable Bottom Panel -->
                        <div x-data="{ showFilters: false }" class="block lg:hidden flex justify-center w-full">
                            <div
                                ...
                                <div class="w-full flex flex-col justify-center items-center bg-white rounded-t-xl pl-1 pr-3">
                                    ...
                                    <div class="overflow-y-auto h-[calc(100%-2rem)] px-0 w-full">
                                        <div  class="flex flex-col gap-3">
                                            ...
                                            <!-- Filters -->
                                            <div x-show="showFilters" @click="expandPanel()"  class="border-t pt-2">
                                                <div x-data="{ activeFilter: '', query: '' }" class="flex flex-wrap justify-start items-start gap-2">
                                                    {{ $dropdown_filters_container }}
                                                </div>
                                            </div>

                                            <!-- Reports -->
                                            <div @click="expandPanel()"  class="flex-1 overflow-y-auto min-h-[25vh] max-h-[60vh] pb-16">
                                                <div class="pb-16 mt-6 px-6 space-y-2">
                        ...
                        <!-- Large screens: Sidebar Panel -->
                        <div class="hidden lg:block">
                            <div class="mt-2 p-0.5 rounded-[20px] h-[68vh] bg-white duration-300 overflow-hidden w-[33%] fixed right-10 top-24 bg-gradient-to-b from-[#84D689] to-green-500 drop-shadow">
                                <div class="bg-white h-full w-full rounded-[18px]">
                                    <div x-data="{ showFilters: false }" class="p-0 block h-full w-full flex flex-col">
                                        <div class="flex flex-wrap gap-2">
                                            <div class="relative flex flex-1 w-7/10 pt-2.5 pb-0">
                                                {{ $search_container }}
                                            </div>
                                            ...
                                            <div class="mt-4 w-2.5/10">
                                                <button
                                                    ...
                                                    class="ml-auto bg-white text-[#F59E0B] px-1 py-2 rounded-md flex items-center shadow-md hover:text-[#D97706] hover:shadow-lg transition-all border border-[#F59E0B] text-xs">
                    ...
                    <!-- Alpine.js Draggable Panel Script -->
                    <script>
...
{{--    <div class="hidden lg:block flex justify-center w-full ">--}}
{{--        <div--}}
{{--            x-data="draggablePanel()"--}}
{{--            x-bind:style="'height: ' + panelHeight"--}}
{{--            @touchstart.passive="startDrag($event)"--}}
...
{{--                        <!-- Report Information -->--}}
{{--                        <div class="flex flex-1 overflow-y-auto min-h-[25vh] max-h-[60vh] pb-16">--}}
{{--                            <div class="pb-16 mt-6 px-6">--}}
{{--                                <div class="space-y-2">--}}
{{--                                    {{ $comprehensive_or_group_report_information }}--}}
{{--                                    {{ $individual_report_information }}--}}
