            ...
            >
                <div class="w-full h-full">
                    <div class="flex items-center justify-center">
                        <div class="p-1 bg-[#3AA76F] border-gray-600 rounded-[12px] shadow-xl overflow-hidden w-full min-w-md max-w-[1/2] min-h-md max-h-lg mx-auto">
                            <div class="bg-[#FBFBFB] rounded-[10px] relative" >
                                ...
                                <!-- Modal Body -->
                                <div class="bg-[#FBFBFB] py-2 rounded-b-[8px] text-gray-600">
                                    {{ $body }}
                                </div>
