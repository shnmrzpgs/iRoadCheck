...
<div x-cloak
    ...
    <div class="flex">
        ...
        <!-- Web screens Sidebarred -->
        <x-admin.admin-web-sidebar>
            <x-slot:navbar_links>
                <!-- Dashboard -->
                <a href="{{ route('admin.dashboard') }}" loading="lazy" class="group flex items-center block p-2 rounded font-medium
                    ...
                    <p x-show="expanded" class="ml-2 text-[xs]
                        {{ request()->routeIs('admin.dashboard') ? 'text-white' : 'text-[#4D4F50] group-hover:text-[#4AA76F] group-hover:font-semibold' }}">
                        Dashboard
                    </p>
                </a>
                <!-- Road Defect Reports -->
                <a href="{{ route('admin.road-defect-reports') }}" loading="lazy" class="lazyload group flex items-center block p-2 rounded font-medium
                ...
                <!-- Manage Staffs -->
                <a href="{{ route('admin.manage-users-table') }}" loading="lazy" class="lazyload group flex items-center block p-2 rounded font-medium
                ...
                <!-- staff Role -->
                <a href="{{ route('admin.staff-roles-table') }}" loading="lazy" class="group flex items-center block p-2 rounded font-medium
                ...
                <div class=" relative" loading="lazy" >
                    ...
                    <a @click="openLogs()" href="javascript:void(0)"
                       class="group flex items-center block p-2 rounded font-medium
                        ...
                        <p x-show="expanded" class="ml-2 mr-auto text-[xs]
                        ...
                        <svg x-show="expanded" :class="{ 'rotate-180': isOpen }"
                    ...
                    <div x-show="isOpen" class="ml-8 mt-2 space-y-2">
                        ...
                        <a href="{{ route('admin.staff-logs-table') }}" x-show="expanded"
                           class=" block py-2 px-5 text-[xs]
                        ...
                        <a href="{{ route('admin.resident-logs-table') }}" x-show="expanded"
                           class=" block py-2 px-5 text-[xs]
                        ...
                        <a href="{{ route('admin.system-logs-table') }}" x-show="expanded"
                           class=" block py-2 px-5 text-[xs]
                ...
                <a href="javascript:void(0);"
                   @click="logout"
                   class="group flex items-center block p-2 rounded hover:text-[#4AA76F] hover:shadow-md font-medium text-[#4D4F50]">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <!-- Content Area -->
            <main
                class="font-pop mt-32 md:mt-24 lg:mt-0 flex-1 rounded-md mb-4 mx-1 lg:mx-0 lg:mr-5 bg-none {{ ' '.$main_class }}">
                <!-- Main content here -->
                {{ $slot }}
            </main>
