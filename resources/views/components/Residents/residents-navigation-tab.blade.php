<x-app-layout>
    <div x-data="{ 
        ...
        class="fixed bottom-0 sm:left-[10%] left-0 right-0 bg-white shadow-[0px_5px_40px_rgba(0,0,0,0.5)] flex justify-between items-center px-4 sm:py-2 py-3 sm:rounded-2xl rounded-t-2xl w-[100%] sm:w-[80%] sm:mb-2 z-50">
        <!-- Dashboard -->
