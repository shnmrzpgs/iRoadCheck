...
<table>
    ...
    <tr>
        <th style="border: 1px solid #101010; background-color: #000000; color: #FFFFFF; font-family: 'Arial', sans-serif; font-size: 10px; text-align: center; font-weight:bold ">No</th>
        <th style="border: 1px solid #101010; background-color: #000000; color: #FFFFFF; font-family: 'Arial', sans-serif; font-size: 10px; text-align: center; font-weight:bold ">Resident Name</th>
        <th style="border: 1px solid #101010; background-color: #000000; color: #FFFFFF; font-family: 'Arial', sans-serif; font-size: 10px; text-align: center; font-weight:bold ">Action</th>
        <th style="border: 1px solid #101010; background-color: #000000; color: #FFFFFF; font-family: 'Arial', sans-serif; font-size: 10px; text-align: center; font-weight:bold ">Date and Time</th>
    </tr>
    </thead>
    <tbody>
