...
<table>
    ...
    <tr>
        ...
        <th style="border-right: 1px solid #101010; background-color: #FFFFFF; color: #252525; font-size: 16px; font-family: 'Arial', sans-serif; text-align: center; font-weight: bold;" colspan="5">
            LIST OF RESIDENT LOGS IN IROADCHECK
        </th>
    </tr>
    <tr>
        <!-- Center the content -->
    ...
    <tr>
        ...
        <th style="border: 1px solid #FFFFFF; background-color: #000000; color: #FFFFFF; width: 90px; font-family: 'Arial', sans-serif; font-size: 10px; text-align: center; font-weight:bold;"  colspan="2">Resident Name</th>
    ...
    @foreach($residentLogs as $log)
        <tr>
            ...
            <td style="border: 1px solid #101010; text-align: left;" colspan="2">{{ $log->resident->name }}</td>
